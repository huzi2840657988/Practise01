...
/**
 	* A data access object (DAO) providing persistence and search support for RoleResource entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.fjsdfx.bean.RoleResource
  * @author MyEclipse Persistence Tools 
 */

public class RoleResourceDAO extends BaseHibernateDAO  {
    ...
    public RoleResource findById( com.fjsdfx.bean.RoleResourceId id) {
        log.debug("getting RoleResource instance with id: " + id);
        try {
            RoleResource instance = (RoleResource) getSession()
                    .get("com.fjsdfx.bean.RoleResource", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(RoleResource instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.fjsdfx.bean.RoleResource")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding RoleResource instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public RoleResource merge(RoleResource detachedInstance) {
        ...
        try {
            RoleResource result = (RoleResource) getSession()
