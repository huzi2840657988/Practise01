...
/**
	 ...
	 * @see com.fjsdfx.bean.Department
...
public class DepartmentDAO extends BaseHibernateDAO  {
		...
		//property constants
	public static final String DPT_DES = "dptDes";
	public static final String DPT_NAME = "dptName";
	public static final String DPT_TYPE = "dptType";
    ...
    public Department findById( java.lang.Integer id) {
        ...
        try {
            Department instance = (Department) getSession()
                    .get("com.fjsdfx.bean.Department", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Department instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.fjsdfx.bean.Department")
	...
	public List findByDptDes(Object dptDes
	) {
		return findByProperty(DPT_DES, dptDes
		);
	}
	
	public List findByDptName(Object dptName
	) {
		return findByProperty(DPT_NAME, dptName
		);
	}
	
	public List findByDptType(Object dptType
	) {
		return findByProperty(DPT_TYPE, dptType
		);
	}
